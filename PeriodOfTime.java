...
*    • получающий часы, минуты и секунды по отдельности.*/
    ...
    public static int gettingSeconds(int hours, int minutes, int seconds){
        int minutesFromHours = hours*60 + minutes;
        int secondsFromMinutes = (minutesFromHours*60) + seconds;
        return secondsFromMinutes;
    }

    public static int gettingMinutes(int hours, int minutes, int seconds){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(gettingSeconds(time.hours, time.minutes, time.seconds) + " c.");
        System.out.println(gettingMinutes(2,15,211) + " min.");
    }
}
